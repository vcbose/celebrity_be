        ...
        try {
            ...
            if (is_array($user_post_image_data) && !empty($user_post_image_data)) {
                ...
                if ($remaining_images >= count($user_post_image_data)) {
                    ...
                    if ($result) {
                        $response['images'] = array('status' => true, 'message' => 'Media has been uploaded successfully');
                    ...
                    $response['images'] = array('status' => false, 'message' => $message);
                }
            }
            ...
            if (is_array($user_post_video_urls) && !empty($user_post_video_urls)) {
                ...
                if ($remaining_videos >= count($user_post_video_urls)) {
                    ...
                    if ($result) {
                        $response['videos'] = array('status' => true, 'message' => 'Media has been uploaded successfully');
                        // $this->response($response, parent::HTTP_OK);
                    } else {
                    ...
                    $response['videos'] = array('status' => false, 'message' => $message);
                }
            }
