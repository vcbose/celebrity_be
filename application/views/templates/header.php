...
<html>
  <head>
    <title>Celebritybe.com</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!-- jQuery UI -->
    <link href="<?php echo asset_url('admin/css/jquery-ui.css'); ?>" rel="stylesheet" media="screen">
    <!-- Bootstrap -->
    <link href="<?php echo asset_url('admin/bootstrap/css/bootstrap.min.css'); ?>" rel="stylesheet">
    <!-- styles -->
    <link href="<?php echo asset_url('admin/css/styles.css'); ?>" rel="stylesheet">
